...
public class Task4event2 extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_task4event2);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.button2){
            intent = new Intent(Task4event2.this, Task4signup.class);
            startActivity(intent);
        } else if (id == R.id.button3) {
            intent = new Intent(Task4event2.this, Task4signup.class);
            startActivity(intent);
        }else if (id == R.id.button5) {
            intent = new Intent(Task4event2.this, Task4.class);
            startActivity(intent);
        }
    }
}